...
Arguments:
    <base_directory> - The base directory of a Luckybit Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Luckybit Core developers'
...
Arguments:
    <base_directory> - The base directory of Luckybit Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Luckybit Core repository.
"""
