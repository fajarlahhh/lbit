...
from test_framework.test_framework import LuckybitTestFramework
...
class LLMQCoinbaseCommitmentsTest(LuckybitTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as LuckybitTestFramework doesn't support this atm)
