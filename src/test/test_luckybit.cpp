...
#define BOOST_TEST_MODULE Luckybit Test Suite

#include "test_luckybit.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_luckybit_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
