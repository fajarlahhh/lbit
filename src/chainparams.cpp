...
// Copyright (c) 2020 The Luckybit Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1608800411, nBits=1e0ffff0, nNonce=246432, vtx=1)
...
{
    const char* pszTimestamp = "Luckybit dibuat tanggal 24 Desember 2020";
    const CScript genesisOutputScript = CScript() << ParseHex("0407addb0e8a0c32367af5cf7736d89a164e77259d182b59c13273c0f82f053297a406fc9bfba8cb8397096987b91df038ffb7fd2f3b9f3283e426c09fcfd73b8c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0000060109c4fb38701bc03c7eb26c4aa199d9c417975af2f00fdadf5adcb31f"); 
        ...
        vAlertPubKey = ParseHex("04d37086462a7f95883eaf98a3b4fb75cf9795478c65f1c2010038792a36fe57d322f10703ce2155ac9da1177469d92fd3f313a25d87fc735842279c8a0b9d8aed");
        nDefaultPort = 26464;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1608800411, 246432, 0x1e0ffff0, 1, 10 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000060109c4fb38701bc03c7eb26c4aa199d9c417975af2f00fdadf5adcb31f"));
        assert(genesis.hashMerkleRoot == uint256S("0x86d7ced3290d6420360d94c501f5f49c75385e563eeff512adb8c78dc5895be1"));
        ...
        // Luckybit BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Luckybit BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Luckybit BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"LVvqNTEi8eFZbGbgRCjk7q5bSLw7vDMKt8"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x0000060109c4fb38701bc03c7eb26c4aa199d9c417975af2f00fdadf5adcb31f"))
        };

        chainTxData = ChainTxData{
            1608800411, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000028404f6df7ab74f00c8e8e8384778193e6bb2c9160d97ef3e0203aa6724"); 

        pchMessageStart[0] = 0xec;
        pchMessageStart[1] = 0xa5;
        pchMessageStart[2] = 0x8a;
        pchMessageStart[3] = 0x4d;
        vAlertPubKey = ParseHex("0408ac1184ed00a17a54d89195d586ff92e96c43854a215b4b297e79751ccc227a43602b8f98f74d18b6eb1207041af8c6769866b9c777ed3714e961e8c14925c7");
        nDefaultPort = 36464;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1608800416UL, 2049553UL, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000028404f6df7ab74f00c8e8e8384778193e6bb2c9160d97ef3e0203aa6724"));
        assert(genesis.hashMerkleRoot == uint256S("0x86d7ced3290d6420360d94c501f5f49c75385e563eeff512adb8c78dc5895be1"));
        ...
        // Testnet Luckybit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Luckybit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Luckybit BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"MQLsYS1DV5brmhbzVuRx4vKNvD2bsTCBoN"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000028404f6df7ab74f00c8e8e8384778193e6bb2c9160d97ef3e0203aa6724"))
        };

        chainTxData = ChainTxData{
            1608800416, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1608800421, 2, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1a69c7c395ef00c10141f3e8e09a392542a663c23b7673c0beb5fa9c13bfcb56"));
        assert(genesis.hashMerkleRoot == uint256S("0x86d7ced3290d6420360d94c501f5f49c75385e563eeff512adb8c78dc5895be1"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("luckybitevo.org",  "devnet-seed.luckybitevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x1a69c7c395ef00c10141f3e8e09a392542a663c23b7673c0beb5fa9c13bfcb56"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6ycamBxjxfc33kDiVAg4KC54rA8ic6gt2yJaUdL1xcCL25qSw6z
        vSporkAddresses = {"MNrxD1ZNSAa8hHU99pwqZf6bMzjhEkr91q"};
        nMinSporkKeys = 1;
        ...
        // Regtest Luckybit addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // Regtest Luckybit script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,51);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Regtest Luckybit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Luckybit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Luckybit BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
