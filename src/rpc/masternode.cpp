...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Luckybit address\n"
            "  payee          - Print the masternode payout Luckybit address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Luckybit address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "luckybit",               "masternode",             &masternode,             true,  {} },
    { "luckybit",               "masternodelist",         &masternodelist,         true,  {} },
    { "luckybit",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "luckybit",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
