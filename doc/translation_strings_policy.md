...
This document provides guidelines for internationalization of the Luckybit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `luckybit_en.ts` remains unchanged.
