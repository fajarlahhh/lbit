...
This mechanism has been integrated into Bitcore-Node-Luckybit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/luckybitpay/insight-api-luckybit#web-socket-api](https://github.com/luckybitpay/insight-api-luckybit#web-socket-api)
* API: [https://github.com/luckybitpay/insight-api-luckybit#instantsend-transactions](https://github.com/luckybitpay/insight-api-luckybit#instantsend-transactions)
